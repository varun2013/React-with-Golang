...
// AdminStatusUpdateNotificationEmail generates an email template for notifying about a patient's kit status update.
func AdminStatusUpdateNotificationEmail(
