...
// AdminKitRegistrationNotificationEmail generates an email template for admin notification
func AdminKitRegistrationNotificationEmail(
           ...
           <tr>
              <td style="padding: 0 30px">
                <p
                  ...
                  "
                >
                Please log in to your portal for more information or to manage the kit.</p>
