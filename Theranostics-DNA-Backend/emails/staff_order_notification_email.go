...
func NewOrderNotificationEmail(
	orderNumber,
	customerFirstName,
	customerLastName,
	customerEmail,
	 ...
	 <tr align="center">
        <td style="padding: 40px 20px 30px 20px">
          ...
          <p
            ...
            "
          >
          We’re excited to inform you that a new order has been placed. Below are the order details:
          </p>
        </td>
      </tr>
      <tr>
